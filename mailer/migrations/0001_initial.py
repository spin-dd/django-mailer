    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="Created At Help", verbose_name="Created At"
                    ),
                ),
                (
                    "updated_at",
                    models.DateTimeField(auto_now=True, help_text="Updated At Help", verbose_name="Updated At"),
                ),
                ...
                (
                    "from_email",
                    models.EmailField(help_text="Sender's email address.", max_length=254, verbose_name="From"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "username",
                    models.CharField(blank=True, default=None, max_length=100, null=True, verbose_name="ユーザー名"),
                ),
                (
                    "password",
                    models.CharField(blank=True, default=None, max_length=100, null=True, verbose_name="パスワード"),
                ),
